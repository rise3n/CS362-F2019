...
int refactored_tribute(int currentPlayer, struct gameState *state, int handPos, int* bonus) {
	...
	result = play_tribute(tributeRevealedCards, currentPlayer,1, state, handPos, bonus);//currentPlayer is 0 and nextPlayer is 1.
...
int main() {
	...
	result = play_tribute(tributeRevealedCards, 0, 1, &G, 2, &bonus);//currentPlayer is 0 and nextPlayer is 1.
	...
	result = play_tribute(tributeRevealedCards, 0, 1, &G, 2, &bonus);
